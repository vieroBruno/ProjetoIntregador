 ...
 * @author Suporte
 */
public class Check_Interface extends javax.swing.JFrame {

    Check_DAO r_DAO = new Check_DAO();
    int cod_hospede = 0;
    int cod_quarto = 0;

    public Check_Interface(int cod_hosp, int cod_quar) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Cod. Hospede", "Hospede", "Cod Quarto", "Quarto", "Data Entrada", "Hora Entrada"
            }
        ) {
    ...
    private void InserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InserirActionPerformed
        Check_DAO rp = new Check_DAO();
        Check xd = new Check();
        xd.setData_check(jFormattedTextField1.getText());
        xd.setHora_check(jFormattedTextField2.getText());
        xd.setCod_hospede(Integer.parseInt(jTextField2.getText()));
        xd.setCod_quarto(Integer.parseInt(jTextField1.getText()));
        xd.setTipo_check("Entrada");
        if (rp.inserir(xd)) {
    ...
    private void jPesquisa_hospedeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jPesquisa_hospedeActionPerformed
        ...
        // do banco de dados
        List<Check> list_res = rp.consulta_check(jNomeHospede.getText());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        Pesquisa_Hospede p = new Pesquisa_Hospede("Chek", cod_quarto);
        p.setVisible(true);
        this.dispose();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here
        Pesquisa_Quarto p = new Pesquisa_Quarto("Chek", cod_hospede);
        p.setVisible(true);
        this.dispose();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (cod != null) {
            ...
            List<Check> listp = r_DAO.consulta_check(Integer.parseInt(cod.toString()));//Implementar metodo de consulta
            //for para percorrer a lista e alimentar alguma coisa
            for (int i = 0; i < listp.size(); i++) {
                //Implementar
                jTextField3.setText(String.valueOf(listp.get(i).getCod()));
                ...
                jFormattedTextField1.setText(listp.get(i).getData_check());
                jFormattedTextField2.setText(listp.get(i).getHora_check());
            }
        }
    ...
    private void ExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExcluirActionPerformed
        // TODO add your handling code here:
        Check xd = new Check();
        xd.setCod(Integer.parseInt(jTextField3.getText()));
        xd.setData_check(jFormattedTextField1.getText());
        xd.setHora_check(jFormattedTextField2.getText());
        xd.setCod_hospede(Integer.parseInt(jTextField2.getText()));
        xd.setCod_quarto(Integer.parseInt(jTextField1.getText()));
        xd.setTipo_check("Entrada");
        if (r_DAO.saida(xd)) {
            JOptionPane.showMessageDialog(rootPane, "Saida com sucesso");
        } else {
            JOptionPane.showMessageDialog(rootPane, "Erro na Saida");
        }
    ...
    public void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Check_Interface(cod_hospede, cod_quarto).setVisible(true);
            }
        });
    }
